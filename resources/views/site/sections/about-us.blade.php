  ...
  <section class="section-padding case-study-brief">
          ...
          <div class="row align-items-xl-center">
              ...
              <div class="col-lg-6 sal-animate" data-sal="slide-right" data-sal-duration="1000">
                  <div class="case-study-featured-thumb">
                      <img class="paralax-image" style="max-height: 600px;" src="{{ asset('storage/app/public/' . $settings::get('about_section_image', '/media/others/mockup.png')) }}" alt="تصميم المنتج" style="will-change: transform; transform: perspective(1000px) rotateX(0deg) rotateY(0deg);" />
      ...
      <div class="container" id="op-vision">
          <div class="row align-items-xl-center">
              ...
              <div class="col-lg-6 sal-animate" data-sal="slide-right" data-sal-duration="1000">
                  <div class="case-study-featured-thumb">
                      <img class="paralax-image" style="max-height: 600px;" src="{{ asset('storage/app/public/' . $settings::get('vision_section_image', '/media/others/mockup.png')) }}" alt="تصميم المنتج" style="will-change: transform; transform: perspective(1000px) rotateX(0deg) rotateY(0deg);" />
                  </div>
              </div>
