                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="privacy-policy-content">
                            ...
                            <p>
                                {!! $settings::get(
                                    'platform_policy_description',
                                    'نحن نلتزم بتقديم تجربة تسوق آمنة وموثوقة، ونحافظ على خصوصية المستخدمين وبياناتهم وفقًا لأعلى المعايير.',
                                ) !!}
                            </p>
                            ...
                            <p>
                                {!! $settings::get(
                                    ...
                                    'نقوم بشحن الطلبات خلال 2-5 أيام عمل. تتوفر خدمة التوصيل إلى جميع المناطق، مع إمكانية تتبع الشحنة بعد الشحن.',
                                ) !!}
                            </p>
                            ...
                            <p>
                                {!! $settings::get(
                                    ...
                                    'يحق للعملاء إرجاع المنتجات خلال 14 يومًا من تاريخ الاستلام بشرط أن تكون بحالتها الأصلية ومرفقة بالفاتورة.',
                                ) !!}
                            </p>
